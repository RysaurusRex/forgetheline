...
const AGENCY_FITNESS: Record<string, {
  ...
  hsi: {
    testName: "HSI Physical Task Test",
    color: "red",
    events: [
      { name: "1.5 Mile Run", requirement: "< 14:45", agencyStandard: "HSI: < 14:45 (competitive)" },
      { name: "Push-ups", requirement: "22+", agencyStandard: "HSI: 22+ (1 minute)" },
      { name: "Sit-ups", requirement: "30+", agencyStandard: "HSI: 30+ (1 minute)" },
      { name: "Agility Course", requirement: "Pass", agencyStandard: "HSI: Obstacle + dummy drag" },
    ],
    trainingWeeks: 8,
    insiderTip: "HSI is growing fast. Physical standards are similar to DEA but with more agilty components.",
  },
  uspis: {
    testName: "USPIS Physical Fitness Test",
    color: "indigo",
    events: [
      { name: "1.5 Mile Run", requirement: "< 15:30", agencyStandard: "USPIS: < 15:30" },
      { name: "Push-ups", requirement: "20+", agencyStandard: "USPIS: 20+ (1 minute)" },
      { name: "Sit-ups", requirement: "25+", agencyStandard: "USPIS: 25+ (1 minute)" },
      { name: "Bench Press", requirement: "70% body weight", agencyStandard: "USPIS: Strength test" },
    ],
    trainingWeeks: 6,
    insiderTip: "USPIS is small but elite. Focus on consistency over speed. Medical exam follows.",
  },
  atf: {
    testName: "ATF Physical Task Test (PTT)",
    color: "orange",
    events: [
      { name: "Sit-ups (1 min)", requirement: "28+", agencyStandard: "ATF: 28+ (untimed)" },
      { name: "Push-ups (1 min)", requirement: "22+", agencyStandard: "ATF: 22+ (untimed)" },
      { name: "1.5 Mile Run", requirement: "< 14:30", agencyStandard: "ATF: < 14:30 (competitive)" },
    ],
    trainingWeeks: 8,
    insiderTip: "ATF PTT is 3 events. Focus on endurance. ATF values consistency over peak performance.",
  },
  cbp: {
    testName: "CBP Border Patrol PTT",
    color: "sky",
    events: [
      { name: "1.5 Mile Run", requirement: "< 13:00", agencyStandard: "CBP: < 13:00 (very competitive)" },
      { name: "Push-ups", requirement: "20+", agencyStandard: "CBP: 20+ (untimed)" },
      { name: "Sit-ups", requirement: "25+", agencyStandard: "CBP: 25+ (untimed)" },
      { name: "Agility Course", requirement: "Pass", agencyStandard: "CBP: Obstacle + wall climb" },
    ],
    trainingWeeks: 6,
    insiderTip: "CBP PTT is very physical. 24/7 shifts mean you need high endurance. Train accordingly.",
  },
  local: {
