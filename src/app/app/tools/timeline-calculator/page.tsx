...
const AGENCY_TIMELINES: Record<string, {
  ...
  hsi: {
    name: "HSI",
    totalMonths: "8-14 months",
    stages: [
      { name: "Application", duration: "2-4 weeks", percentage: 10, tip: "Apply via USAJOBS.gov. OPM-1811 series.", color: "bg-red-500" },
      { name: "Written Exam", duration: "2-3 weeks", percentage: 20, tip: "Language exam if applicable.", color: "bg-red-500" },
      { name: "Background", duration: "4-8 months", percentage: 50, tip: "Top Secret clearance required.", color: "bg-red-500" },
      { name: "Polygraph", duration: "2-3 weeks", percentage: 70, tip: "Validation of SF-86 questionnaire.", color: "bg-red-500" },
      { name: "Management Interview", duration: "2-3 weeks", percentage: 85, tip: "Behavioral questions + agency overview.", color: "bg-red-500" },
      { name: "Basic Inspector Training", duration: "16 weeks", percentage: 100, tip: "Residential program in Potomac, MD.", color: "bg-red-500" },
    ],
  },
  uspis: {
    name: "USPIS",
    totalMonths: "6-12 months",
    stages: [
      { name: "Application (IRAS)", duration: "2-3 weeks", percentage: 10, tip: "Use Inspector Recruitment Application System.", color: "bg-indigo-500" },
      { name: "Entrance Exam", duration: "4-6 weeks", percentage: 20, tip: "Online exam + verification test.", color: "bg-indigo-500" },
      { name: "Background Inv.", duration: "3-6 months", percentage: 45, tip: "Top Secret clearance investigation.", color: "bg-indigo-500" },
      { name: "Polygraph", duration: "2-3 weeks", percentage: 65, tip: "Validates SF-86 information.", color: "bg-indigo-500" },
      { name: "Medical & Drug Test", duration: "2-3 weeks", percentage: 80, tip: "Must meet physical/mental standards.", color: "bg-indigo-500" },
      { name: "Basic Inspector Training", duration: "16 weeks", percentage: 100, tip: "Residential program in Potomac, MD.", color: "bg-indigo-500" },
    ],
  },
  atf: {
    name: "ATF",
    ...
    stages: [
      { name: "Application", duration: "2-4 weeks", percentage: 10, tip: "Apply via USAJOBS.gov. Submit SF-86.", color: "bg-orange-500" },
      { name: "Written Exam (SAAA)", duration: "4-6 weeks", percentage: 20, tip: "Special Agent Applicant Assessment.", color: "bg-orange-500" },
      { name: "Physical Task Test", duration: "2-3 weeks", percentage: 35, tip: "Sit-ups, push-ups, 1.5-mile run.", color: "bg-orange-500" },
      { name: "Structured Interview", duration: "4-8 months", percentage: 60, tip: "Panel interview + writing sample.", color: "bg-orange-500" },
      { name: "Background & Poly", duration: "3-6 months", percentage: 80, tip: "Top Secret clearance required.", color: "bg-orange-500" },
      { name: "ATF Academy", duration: "15 weeks", percentage: 100, tip: "FLETC + ATF Basic (7 months total).", color: "bg-orange-500" },
    ],
  },
  cbp: {
    ...
    stages: [
      { name: "Application", duration: "1-2 weeks", percentage: 10, tip: "Apply via USAJOBS.gov. Veterans exempt from age limit.", color: "bg-sky-500" },
      { name: "Entrance Exam", duration: "2-4 weeks", percentage: 20, tip: "Experience Record + Logical Reasoning.", color: "bg-sky-500" },
      { name: "Physical Fitness", duration: "2-3 weeks", percentage: 35, tip: "Sit-ups, push-ups, 1.5-mile run.", color: "bg-sky-500" },
      { name: "Structured Interview", duration: "2-4 weeks", percentage: 50, tip: "Panel interview with SMEs.", color: "bg-sky-500" },
      { name: "Background & Poly", duration: "1-3 months", percentage: 70, tip: "Faster than FBI/DEA.", color: "bg-sky-500" },
      { name: "Academy", duration: "6 months", percentage: 100, tip: "Border Patrol Academy in Artesia, NM.", color: "bg-sky-500" },
    ],
  },
  local: {
    name: "Local PD",
