...
const AGENCY_COLORS: Record<string, { bg: string; border: string; text: string; badge: string }> = {
  ...
  hsi: { bg: "bg-red-50", border: "border-red-200", text: "text-red-900", badge: "bg-red-100 text-red-800" },
  uspis: { bg: "bg-indigo-50", border: "border-indigo-200", text: "text-indigo-900", badge: "bg-indigo-100 text-indigo-800" },
...
const AGENCIES = {
  ...
  hsi: {
    ...
    color: "red",
    pay: { entry: "GL-7/9: $52,560 - $73,375", top: "GS-13: $120,285 - $156,371", note: "Plus 25% LEAP", rank: 3 },
    requirements: { age: "21-36 (veterans up to 40)", education: "Bachelor's OR experience", experience: "Law enforcement preferred", citizenship: "US citizen", clearance: "Top Secret" },
    locations: { total: "26 Special Agent in Charge offices", major: "Major cities, border towns", international: "80+ foreign offices" },
    workLife: { hours: "45-55/week", schedule: "Regular business hours", travel: "Moderate", balance: 3, balanceLabel: "Moderate" },
    culture: { vibe: "Investigative, detail-oriented", diversity: "30% Hispanic agents", promotion: "GS-7 → GS-13 in 5-7 years" },
    veterans: "5 or 10-point preference",
    disqualifiers: ["Felony convictions", "Past drug use", "Failed polygraph", "Poor credit"],
    hiring: { timeline: "8-14 months", difficulty: "Competitive (10-15%)", phases: "Written → Background → Poly → Interview → Medical", rank: 3 },
    insiderTips: [
      "HSI is growing fast. Apply NOW before it gets more competitive.",
      "Language skills (Spanish, Mandarin) = huge advantage.",
      "HSI does both immigration AND customs violations. Broad mandate.",
      "Basic Inspector Training is 16 weeks in Potomac, MD.",
    ],
  },
  uspis: {
    name: "USPIS",
    ...
    color: "indigo",
    pay: { entry: "GL-7/9: $52,560 - $73,375", top: "GS-13: $120,285 - $156,371", note: "Plus 25% LEAP", rank: 3 },
    requirements: { age: "21-36 (veterans up to 40)", education: "Bachelor's required", experience: "No experience required", citizenship: "US citizen", clearance: "Top Secret" },
    locations: { total: "220+ district offices", major: "All 50 states", international: "Limited" },
    workLife: { hours: "40-50/week", schedule: "Regular business hours", travel: "Moderate", balance: 4, balanceLabel: "Good" },
    culture: { vibe: "Small, elite, focused", diversity: "25% female agents", promotion: "Slower but steady" },
    veterans: "5 or 10-point preference",
    disqualifiers: ["Felony convictions", "Past drug use", "Failed polygraph", "Poor driving"],
    hiring: { timeline: "6-12 months", difficulty: "Moderate (20%)", phases: "Exam → Background → Poly → Medical → Academy", rank: 2 },
    insiderTips: [
      "USPIS is small (1,100 agents). Very tight-knit community.",
      "Mail fraud, narcotics, child exploitation. Diverse cases.",
      "Basic Inspector Training is 16 weeks in Potomac, MD.",
      "USPIS has highest conviction rate of all 1811s (95%+).",
    ],
  },
}
